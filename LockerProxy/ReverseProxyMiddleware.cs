...
using System.Threading.Tasks;
  ...
  public class ReverseProxyMiddleware
  {
    ...
    public ReverseProxyMiddleware(RequestDelegate nextMiddleware, IConfiguration configuration)
    {
      ...
      _fileServerUrl = configuration.GetValue<String>("FILE_SERVER_URL");
    }
    ...
    public async Task Invoke(HttpContext context)
    {
      ...
      if (authHeader != null && authHeader.StartsWith("Bearer"))
      {
        ...
        if (targetUri != null && token == "mytoken")
        {
    ...
    {
      Uri targetUri = new Uri(_fileServerUrl+ request.Path);
      return targetUri;
    }
  }